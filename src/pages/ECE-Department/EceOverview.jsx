...
import styles from './EceOverview.module.css';

const API_BASE_URL = 'https://ccet.ac.in/api/overview.php';
const DEPARTMENT_CODE = 'ECE';
...
const EceOverview = () => {
    ...
    if (loading) {
        return (
            <SharedEceLayout pageTitle="Overview">
        ...
        <SharedEceLayout pageTitle="Overview">
                ...
                <div ref={el => animatedElementsRef.current[1] = el} className={`${styles.deptInfoContainer} ${styles.animateOnScroll}`}>
                    <div className={styles.deptInfoHeader}>
                        <h2 style={{fontSize: '40px'}}>
                            {departmentInfo?.department_name || 'Department of Electronics and Communication Engineering'}
                        </h2>
                        <p style={{fontSize: '20px'}}>
                            {departmentInfo?.tagline || 'Excellence in communication systems and electronic technologies'}
                        </p>
                    </div>
                    ...
                    {programOutcomes.length > 0 && (
                        <>
                            ...
                            <div ref={el => animatedElementsRef.current[11] = el} className={`${styles.infoCard} ${styles.animateOnScroll} ${styles.delay1}`}>
                                <p>Graduates of the Electronics and Communication Engineering program will demonstrate:</p>
                                <ul>
            ...
            {gallery.length > 0 && (
                <section className={styles.tourSection}>
                    <h2 ref={el => animatedElementsRef.current[24] = el} className={`${styles.sectionTitle} ${styles.animateOnScroll}`}>ECE Department Tour</h2>
                    <div className={styles.sectionUnderline} style={{filter: 'none'}}></div>
