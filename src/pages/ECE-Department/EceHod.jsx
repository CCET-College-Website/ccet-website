...
import styles from './EceHod.module.css';
...
const EceHod = () => {
    ...
    const fetchHodData = async () => {
        ...
        try {
            ...
            if (Array.isArray(data) && data.length > 0) {
                // Get the most recent HOD entry for ECE department
                setHodData(data[0]);
    ...
    if (loading) {
        return (
            <SharedEceLayout pageTitle="HOD Desk">
            ...
            <div className={styles.container}>
                ...
                <div className={styles.profileSection}>
                    ...
                    <div className={styles.hodInfo}>
                        ...
                        <p className={styles.department}>Electronics & Communication Engineering Department</p>
                    </div>
