...
const PhdProgrammes = () => {
    ...
    useEffect(() => {
        fetch("https://ccet.ac.in/api/programmes.php?type=phd&status=active")
            .then((response) => {
            ...
            .catch((err) => {
                console.error("Error fetching PhD programme:", err);
        ...
        return (
            <div className="phd-container">
                <div style={{ textAlign: 'center', padding: '4rem' }}>
                    <p>Loading PhD programme data...</p>
                </div>
            </div>
        );
    }
        ...
        return (
            <div className="phd-container">
                <div style={{ textAlign: 'center', padding: '4rem', color: '#dc3545' }}>
                    <p>Error loading PhD programme data: {error}</p>
    ...
    return (
        <div className="phd-container">
            <h1 className="phd-title">{programmeData.title}</h1>
