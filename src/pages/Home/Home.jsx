...
function FloatingHelpDeskTab() {
    return (
        <Link to="/admissions/help-desk" className={styles.hdFloatPill}>
            <span className={styles.hdPhoneCircle}>
                <svg className={styles.hdPhoneIcon} width="18" height="18" viewBox="0 0 24 24" fill="currentColor" stroke="none">
            ...
            <span className={styles.hdPillLabel}>Admissions Helpdesk</span>
        </Link>
    );
}
