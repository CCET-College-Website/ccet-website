    ...
    const fetchHostelData = async () => {
        ...
        try {
            const [staffRes, noticesRes, formsRes, galleryRes, rulesRes, documentsRes] = await Promise.all([
                fetch(`${API_BASE_URL}?entity=staff&hostel_type=girls&is_active=true`),
                fetch(`${API_BASE_URL}?entity=notices&hostel_type=girls&is_active=true`),
                fetch(`${API_BASE_URL}?entity=forms&hostel_type=girls&is_active=true`),
                fetch(`${API_BASE_URL}?entity=gallery&hostel_type=girls&is_active=true`),
                fetch(`${API_BASE_URL}?entity=rules&hostel_type=girls&is_active=true`),
                fetch(`${API_BASE_URL}?entity=documents&hostel_type=girls&is_active=true`)
            ]);
