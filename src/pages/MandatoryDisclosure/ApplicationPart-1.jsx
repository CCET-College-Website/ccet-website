...
const Partone = () => {
    ...
    const TAB_ID = 38; // Application Part-1 tab ID
    ...
    const fetchPdfs = async () => {
        ...
        try {
            ...
            console.error("Application Part-1 fetch error:", err);
            setPdfs([]);
        } finally {
            setLoading(false);
        }
    ...
    return (
        <div className={styles.container}>
            <h1 className={styles.heading}>
                {currentPdf?.pdf_name || 'Existing Institution Application Report Part 1 (2025-2026)'}
            </h1>
            <div className={styles.underline}></div>
            ...
            <div className={styles.pdfPlaceholder}>
                <iframe
                    src={pdfUrl}
                    title={currentPdf?.pdf_name || 'Existing Institution Application Report Part 1'}
            ...
            >
                <Download size={20} />
                Download {currentPdf?.pdf_name || 'Report (Part 1) 2025-2026'}
            </button>
        </div>
    );
};
