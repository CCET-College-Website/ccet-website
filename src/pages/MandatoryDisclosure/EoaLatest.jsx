...
const EoaLatest = () => {
    ...
    const TAB_ID = 37; // EoA Report 2025-26 tab ID
    ...
    const fetchPdfs = async () => {
        ...
        try {
            ...
            console.error("EOA fetch error:", err);
            setPdfs([]);
        } finally {
            setLoading(false);
        }
    ...
    return (
        <div className={styles.container}>
            <h1 className={styles.heading}>
                {currentPdf?.pdf_name || 'EOA Report 2025-2026'}
            </h1>
            <div className={styles.underline}></div>
            ...
            <div className={styles.pdfPlaceholder}>
                <iframe
                    src={pdfUrl}
                    title={currentPdf?.pdf_name || 'EOA Report 2025-2026'}
            ...
            >
                <Download size={20} />
                Download {currentPdf?.pdf_name || 'EOA Report 2025-2026'}
            </button>
        </div>
    );
};
